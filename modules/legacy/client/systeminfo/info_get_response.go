...
func (m *InfoGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["info"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateInfoGetResponse_infoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetInfo(val.(InfoGetResponse_infoable))
        }
        return nil
    }
...
func (m *InfoGetResponse) GetInfo()(InfoGetResponse_infoable) {
    return m.info
}
...
func (m *InfoGetResponse) SetInfo(value InfoGetResponse_infoable)() {
    m.info = value
}
